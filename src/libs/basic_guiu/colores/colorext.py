...
"""
    Dicionario de colores en formato RGBA para usar en PyGame
    ...
    Descripcion:
        Esta es una Adaptacion de la libreria de pygame 'colordict.py' esta
        adaptacion las define directamente como constantes en ves de un solo
        dicionario.
"""
